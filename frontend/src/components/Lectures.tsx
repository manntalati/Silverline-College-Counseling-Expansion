            ...
            <div className="destination">
              <div className="mt-3">
                <div className="media-entry media-entry-original">
                  ...
                  >
                    <img src={tom} alt="Tom" className="img-fluid" />
                  </a>
              ...
              <div className="mt-4">
                <div className="media-entry media-entry-original">
                  <a
                    ...
                    className="text-center"
                  >
                    <img src={emily} alt="Emily" className="img-fluid" />
                  </a>
                  <div className="m-body">
                    ...
                    <div style={{ textAlign: "start" }}>
                      <p>
                        Overview:{" "}
                        <span style={{ color: "#AFA99E" }}>
                          Emily Hanscom joined us for our third lecture. She is
                          a junior at Marist College. The main focus of her
                          lecture was figuring out the college application in
                          terms of the financial aspect. For example, she
                          explained the different financial avenues to achieve
                          higher education.
                        </span>
                      </p>
                      <p>
              ...
              <div className="mt-4">
                <div className="media-entry media-entry-original">
                  <a
                    ...
                    className="text-center"
                  >
                    <img src={vishant} alt="Vishant" className="img-fluid" />
                  </a>
                  <div className="m-body">
                    ...
                    <div style={{ textAlign: "start" }}>
                      <p>
                        ...
                        <span style={{ color: "#AFA99E" }}>
                          ...
                          rising freshman at Carnegie Mellon University. Vishant
                          spoke about the college admissions process but focused
                          more on the most optimal ways to frame an application.
                        </span>
                      </p>
                      <p>
              ...
              <div className="mt-4">
                <div className="media-entry media-entry-original">
                  <a
                    ...
                    className="text-center"
                  >
                    <img src={shivani} alt="Shivani" className="img-fluid" />
                  </a>
                  <div className="m-body">
