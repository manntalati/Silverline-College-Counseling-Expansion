  ...
  return (
    <>
      ...
      <div className="section">
        <div className="container" style={{ color: "#D6D3CD", position: "relative" }}>
          <h1 className="pt-3">Our Partners & Sponsors</h1>
          <br />
          <p>
            Several businesses, non-profits, and organizations in the United States help bring the Silverline image to reality. Partners provide resources, funds, or other necessities required to create a functioning organization. Interested in helping Silverline solve the educational divide? Contact a representative{" "}
            <a target="_0" href="https://docs.google.com/document/d/1UMz9CIYSuJ1WEQWuOusSQlHchQwpgFmqwVLOTzX0D9w/edit">
              here
            </a>
            .
          </p>
          <div className="row align-items-stretch">
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                <a href="https://www.joinbumper.com/ambassadors" target="_0" style={{ background: "none" }} className="text-center">
                  <img src={partner2} alt="Bumper Investing" className="img-fluid" />
                </a>
                <div className="m-body">
                  <h6 style={{ padding: "5px", borderRadius: "5px", background: "linear-gradient(90deg, rgba(53,155,215,1) 0%, rgba(129,132,191,1) 50%, rgba(213,67,152,1) 100%)", textAlign: "center" }}>Bumper Investing</h6>
                  <p>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                <a href="https://www.canva.com/" target="_0" style={{ background: "none" }} className="text-center">
                  <img src={partner3} alt="Canva" className="img-fluid" />
                </a>
                <div className="m-body">
                  <h6 style={{ padding: "5px", borderRadius: "5px", background: "#3FC1C9", textAlign: "center" }}>Canva</h6>
                  <p>
                    Canva is a powerful design tool that can be used in education to create projects. In addition, Canva seeks to teach students the basics of design, paralleling the Silverline vision. Silverline is one of several non-profits Canva supports as a part of their non-profit initiative. As an organization, Silverline utilizes such tools for social media posts, content creation, and more.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                <a href="https://rdcrss.org/silverlinetutoringinc" target="_0" style={{ background: "none" }} className="text-center">
                  <img src={partner4} alt="American Red Cross" className="img-fluid" />
                </a>
                <div className="m-body">
                  <h6 style={{ padding: "5px", borderRadius: "5px", background: "#F10000", textAlign: "center" }}>American Red Cross</h6>
                  <p>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                <a href="https://365tojapan.com/" target="_0" style={{ background: "none" }} className="text-center">
                  <img src={partner5} alt="365toJapan" className="img-fluid" />
                </a>
                <div className="m-body">
                  <h6 style={{ padding: "5px", borderRadius: "5px", background: "#F08811", textAlign: "center" }}>365toJapan</h6>
                  <p>
                    365toJapan is an educational blog covering the course of an enthusiastic Japanese learner. Their mission is to one day visit Japan as an immersed student. The blog covers language, culture, and more, serving as a space for new and experienced learners. As an organization, Silverline helps support strong and creative educational causes such as 365toJapan through promotions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                <a href="https://www.linkedin.com/company/sultan-s-marketing/" target="_0" style={{ background: "none" }} className="text-center">
                  <img src={partner6} alt="Sultan's Marketing" className="img-fluid" />
                </a>
                <div className="m-body">
                  <h6 style={{ padding: "5px", borderRadius: "5px", background: "black", textAlign: "center" }}>Sultan's Marketing</h6>
                  <p>
                    Sultan’s Marketing is a startup marketing company that offers social media marketing services to local businesses. They help businesses adapt to the new generation and grow to the next level by increasing their brand awareness and presence in the social media sphere. They aim to provide low price and high-quality marketing services to small businesses and big businesses alike.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                <a href="https://www.community-fundraiser.com/virtual-fundraiser/events/promotions/104b6bfb-4dbd-b890-b2a1-4f237692f082/en/landing" target="_0" style={{ background: "none" }} className="text-center">
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                <a href="https://www.equalityinforensics.org/" target="_0" style={{ background: "none" }} className="text-center">
                  <img src={partner8} alt="Equality in Forensics" className="img-fluid" />
                </a>
                <div className="m-body">
                  <h6 style={{ padding: "5px", borderRadius: "5px", background: "linear-gradient(90deg, rgba(191,43,43,1) 0%, rgba(203,50,50,1) 33%, rgba(225,120,120,1) 62%, rgba(253,163,163,1) 89%)", textAlign: "center" }}>Equality in Forensics</h6>
                  <p>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                <a href="https://www.chipotle.com/" target="_0" style={{ background: "none" }} className="text-center">
                  <img src={partner9} alt="Chipotle of Drumhill Chelmsford, MA" className="img-fluid" />
                </a>
                <div className="m-body">
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                <a href="https://www.thewishproject.org/" target="_0" style={{ background: "none" }} className="text-center">
                  <img src={partner10} alt="The Wish Project" className="img-fluid" />
                </a>
                <div className="m-body">
                  <h6 style={{ padding: "5px", borderRadius: "5px", background: "linear-gradient(90deg, rgba(61,188,193,1) 0%, black 100%)", textAlign: "center" }}>The Wish Project</h6>
                  <p>
                    The Wish Project’s mission is to help families in need establish long-term residency by providing basic needs to provide critical immediate assistance to homeless families, victims of fire or disaster; and to support the community. After realizing a similarity in mission statements, the Wish Project began working with Silverline to help the local Massachusetts area and solve local educational disparities.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                <a href="https://chs.chelmsfordschools.org/" target="_0" style={{ background: "none" }} className="text-center">
                  <img src={partner11} alt="Chelmsford High School" className="img-fluid" />
                </a>
                <div className="m-body">
