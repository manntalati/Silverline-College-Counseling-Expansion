								...
								<div className="destination">
									<div className="mt-3">
										<div className="media-entry media-entry-original">
											...
											>
												<img
													src={require("../images/Home/lectures/tom.webp")}
													alt="Tom"
													className="img-fluid"
												/>
											</a>
								...
								<div className="destination">
									<div className="mt-4">
										<div className="media-entry media-entry-original">
											...
											>
												<img
													src={require("../images/Home/lectures/emily.webp")}
													alt="Emily"
													className="img-fluid"
												/>
											</a>
											<div className="m-body">
												...
												>
													<p>
														...
														>
															Emily Hanscom joined
															us for our third
															lecture. She is a
															junior at Marist
															College. The main
															focus of her lecture
								...
								<div className="destination">
									<div className="mt-4">
										<div className="media-entry media-entry-original">
											...
											>
												<img
													src={require("../images/Home/lectures/vishant.webp")}
													alt="Vishant"
													className="img-fluid"
												/>
											</a>
								...
								<div className="destination">
									<div className="mt-4">
										<div className="media-entry media-entry-original">
											...
											>
												<img
													src={require("../images/Home/lectures/shivani.webp")}
													alt="Shivani"
													className="img-fluid"
												/>
											</a>
