    ...
    <>
      <div className="section">
        ...
        <div className="container" style={{ color: "#D6D3CD", position: "relative" }}>
          <h1 className="pt-3">Our Partners & Sponsors</h1><br />
          <p>Several businesses, non-profits, and organizations in the United States help bring the Silverline image to reality. Partners provide resources, funds or other necesseities required to create a functioning organization. Interested in helping Silverline solve the educational divide? Contact a represensative <a target="_0"
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                ...
                <div className="bg-white m-body">
                  ...
                  <p>Bumper is an educational investing platform that helps teens begin investing with just $1 and an adult sponsor. Join the hundreds of teens in their ambassador program, a 9-week program focused on gaining real world experience in the investing world. Gain access to perks and rewards while helping fulfill Bumper's mission of expanding future opportunities for students through investing.</p>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                ...
                <div className="bg-white m-body">
                  ...
                  <p>Canva is a powerful design tool that can be used in education to create projects. In addition, Canva seeks to teach students the basics of designs, parallelling the Silverline vision. Silverline is one of several non-profits Canva supports as a part of their non-profit initiative. As an organization, Silverline utilizes such tools for social media posts, content creation, and more.</p>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                ...
                <div className="bg-white m-body">
                  ...
                  <p>365toJapan is an educational blog covering the course of an enthusiastic Japanese learner. Their mission is to one day visit Japan as an immersed student. The blog covers language, culture, and more, serving as a space for new and experienced learners. As an organization, Silverline helps supports strong and creative educational causes such as 365toJapan through promotions.</p>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                ...
                <div className="bg-white m-body">
                  ...
                  <p>Panda Express is an American fast food restaurant chain that serves American Chinese cuisine. With over 2,200 locations, it is the largest Asian-segment restaurant chain in the United States. They are working with Silverline Tutoring to help fundraise and donate resources to children in India and Ethopia.</p>
            ...
            <div className="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div className=" media-entry media-entry-copy media-size3">
                ...
                <div className="bg-white m-body">
                  ...
                  <p>The Wish Project’s mission is to help families in need establish long-term residency by providing basic needs to provide critical immediate assistance to homeless families, victims of fire or disaster; and to support the community. After realizing a a similarity in mission statements, the Wish Project began working with Silverline to help the local Massachusetts area and solve local educational disparities.</p>
